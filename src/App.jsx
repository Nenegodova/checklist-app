...
shopping: {
  ...
  tests: {
    "Текст": [
      ...
      { _sortOrder: 6,
        text: "Внутри конфига есть все необходимые склейки" }
    ],
...
const DATA = {
  ...
  text: "Везде проставлены верные уровни заголовков (*h2*, *h2 level=”2”*, *h3* для плашек)"
    ...
    { text: "Внутри склеяны *<nobr></nobr>* диапазоны чисел, составные наречия, °C, пишущиеся через дефис слова (до 4 символов от дефиса), числа, которые идут после того, что считаем (минут 15, iPhone 16), аббревиатуры-дополнения (страны ЕС, ставка ЦБ, Витамин C)" },
