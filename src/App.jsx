...
const DATA = {
  "Админка": [
    ...
    { text: "Размер обложки, подпись к обложке в нужном месте (под обложкой/в подвале), актуальность текста, 18+ не обрезается на ОГ, текст на ОГ оттипирован (проставлены склейки)" },
  ...
  "Текст": [
    ...
    { text: "Внутри склеяны *&nbsp;* слова с частицами бы, же, ли, числа, которые идут после того, что считаем (минут 15, iPhone 16), аббревиатуры-дополнения (страны ЕС, ставка ЦБ, Витамин C)" },
    { text: "Поправить типографирование: м², а не м2, 1/3, а не ⅓" },
  ...
  "Таблицы": [
    ...
    { text: "Строки отсортированы по числовой колонке в порядке уменьшения если это уместно" }
  ],
  ...
  "Картинки": [
    ...
    { text: "Скрины ретиновые и чистые, соблюдены поля, проставлен bordered если фон сливается с фоном страницы" },
    { text: "Проверить необходимость bordered у видео" },
    { text: "Проверить необходимость aspect ratio" },
  ...
  "Прочее": [
    ...
    { text: "Рекламные поля не стоят рядом с баннерами, анкетами, картинками и таблицами" },
