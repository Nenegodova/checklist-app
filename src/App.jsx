...
const DATA = {
  ...
  links: [
    ...
    "*В тестах* в мини-тестах из одного вопроса автор и подпись стоят перед лидом",
    "*В тестах* в подвале у больших тестов и кроссвордов прописаны авторы и источники картинок"
  ]
};
