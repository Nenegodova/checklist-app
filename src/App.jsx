...
const DATA = {
  "Админка": [
    ...
    { id: "cover-type", text: "Проверить тип обложки, кредит к обложке в нужном месте (под обложкой/в подвале), наличие бирки на ОГ, наличие метки 18+, текст на ОГ оттипирован (проставлены склейки)" },
