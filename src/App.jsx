...
const DATA = {
  "Админка": [
    ...
    { text: "Проверить скрытие для материалов 18+" },
    ...
    { id: "cover-type", text: "Проверить тип обложки, наличие бирки на ОГ, наличие метки 18+, текст на ОГ оттипографирован" },
    { id: "credit", text: "Проверить автора обложки или источники" },
    { links: [{ label: "Маркировки иноагентов и экстремистов", url: "https://tinkoffjournal.kaiten.ru/documents/d/05e4af49-d4af-433d-a183-528ac0d4da1a" }] },
  ...
  "Текст": [
    ...
    { text: "Якорные ссылки рабочие и ведут на нужные разделы. У заголовка оглавления нет двоеточия в конце" },
    { id: "heading-levels", text: "Везде проставлены верные уровни заголовков (h2, h2 level=\"2\", h3 для плашек)" },
    { text: "Проверить необходимость бирок над заголовками и проставить их в нужных местах" },
    ...
    { id: "utm", text: "У ссылок нет ненужных utm-меток" },
    ...
    { id: "lists-style", text: "Проверить списки: цифровые и кастомные — с большой буквы, в конце пунктов точки. Списки с буллитами — с маленькой буквы, в конце пунктов точка с запятой, у последнего пункта — точка" },
    ...
    { text: "Проверить везде ли где нужно проставлены виджеты, фичеры, баннеры, этажи, кат" },
  ],
  "Таблицы": [
  ...
  "Выпуск": [
    ...
    { text: "При отложенной публикации в катен прикреплена ссылка на материал, проставлено время выпуска в заголовке карточки и в сроке выпуска" },
    { text: "После выпуска проверить материал на главной: все ли впорядке с обложкой, красиво ли стоят переносы в заголовке" },
  ],
  "Прочее": [
