...
const PRESETS = {
  ...
  tests: {
    Текст: [
      {
        _sortOrder: 0,
        text: "В мини-тестах из одного вопроса автор и подпись стоят перед лидом",
      },
  ...
  cd: {
    Админка: [
      ...
      {
        _sortOrder: 2,
        text: "Если статья 18+, выбрана облога с биркой 18+",
      },
      {
        _sortOrder: 6,
    ...
    Текст: [
      ...
      { text: "Есть автор вопроса и вопрос в плашке bubble" },
  ...
  shorts: {
    ...
    Текст: [
      ...
      {
        text: 'Дискрипшн находится перед закрывающим тегом, под последней карточкой внутри <tiles></tiles> и тега p grade="small"',
      },
      {
  ...
  ugc3: {
    Админка: [
      ...
      {
        _sortOrder: 2,
        text: "В out cтоит готовая обложка-заглушка out-hate-сap, поле «Обложка» оставляем пустым. Картинка mini — дублирует out. Опенграфы генерируем из out с затемнением и белым текстом.",
        links: [
          {
            label: "Памятка",
    ...
    Прочее: [
      {
        ...
        links: [
          {
            label: "Пример статьи",
            url: "https://t-j.ru/tolpy-liudei-i-sueta-v-pvz-hate/",
          },
        ],
      },
      {
  ...
  ugc5: {
    Админка: [
      ...
      {
        _sortOrder: 3,
        text: "ОГ⁠⁠-⁠⁠заг = заголовок статьи, текст на ОГ-картинке оттипографирован, ОГ-описание: «Точка зрения читателя» или «Точка зрения читательницы»",
      },
  ...
  ugc7: {
    Админка: [
      ...
      {
        _sortOrder: 2,
        text: "ОГ⁠⁠-⁠⁠заг = заголовок статьи, ОГ-описание: «Дискуссия Т—Ж» или «Дискуссия Учебника Т—Ж», текст на ОГ-картинке оттипографирован, на ОГ-картинках добавлена бирка «Дискуссия»",
      },
    ],
    ...
    Выпуск: [
      {
        _sortOrder: 1,
        text: "Перед публикацией материала на главной проверить, что в числе последних 5 материалов нет других дискуссий",
      },
    ],
    Прочее: [
      {
        ...
        links: [
          {
            ...
            url: "https://t-j.ru/career-question-kak-razvivatsia-v-usloviiakh-gonki/",
          },
        ],
      },
      {
  ...
  ugc19: {
    ...
    Текст: [
      ...
      {
        _sortOrder: 13,
        text: "В конце добавлена плашка «Собираем бриллианты из Сообщества» (сниппет pnldimond)",
      },
    ],
    Прочее: [
      {
...
export const DATA = {
  ...
  Выпуск: [
    ...
    {
      text: "После выпуска проверить материал на главной: все ли в порядке с обложкой",
    },
  ],
};
